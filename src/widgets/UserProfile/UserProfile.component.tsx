		...
		<div className={styles.profile}>
			...
			<div className={styles.username}>
				<div className={styles.userInfo}>
					{username} {pronouns && <span className={styles.pronouns}>{pronouns}</span>} {badge &&
						<Popup>
							<PopupWrapper>
							...
							<PopupTrigger>
								<span className={clsx(styles.badge, badge === 'NextLink' && styles.nextLink)}>{badge} <Icon icon="question_mark"></Icon></span>
							</PopupTrigger>
						</Popup>
					}
				</div>
