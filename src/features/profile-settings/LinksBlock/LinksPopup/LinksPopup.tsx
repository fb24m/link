...
export const LinksPopup = ({ userLinks }: { userLinks: any[] }) => {
	...
	const [message, action] = useActionState(updateLinks, null)
			...
			<PopupWrapper>
				...
				<div className={styles.links}>
					{Object.keys(allLinks).map(link => {
						...
						return <div className={styles.linkTag} key={JSON.stringify(link)}>
				...
				<p className={styles.label}>
					Preview version. May not work and is subject to change
				</p>

				<PopupFooter>
					<SubmitButton type="submit" appearance="primary">Сохранить</SubmitButton>
				</PopupFooter>
			</PopupWrapper>
		</form>
		<PopupTrigger>
