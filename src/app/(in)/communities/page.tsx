      ...
      <Card className={styles.card}>
        <form className={styles.form} action={createCommunity}>
          ...
          <div className={styles.block}>
            ...
            <div className={styles.inputBlock}>
              <Textarea
                ...
                name="bio"
                type="text"
                placeholder="Сообщество на NextLink"
              />
            </div>
          </div>
          <div className={styles.block}>
            <h3 className={clsx(styles.title, styles.smallBlock)}>
              Ваше сообщество будет:
            </h3>
          ...
          <span className={styles.buttonBg}>
            <SubmitButton className={styles.button} appearance="primary">
              Начнём
            </SubmitButton>
          </span>
        </form>
